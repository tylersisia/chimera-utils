ChimeraCrypto// Copyright (c) 2019, The TurtleCoin Developers
//
...
function loadBrowserWASM () {
  ...
  try {
    const Self = window.ChimeraCrypto()
...
function loadNativeAddon () {
  try {
    const Self = require('chimera-crypto')
...
function loadNativeJS () {
  try {
    const Self = require('./chimera-crypto.js')()
...
function loadWASMJS () {
  ...
  try {
    const Self = require('./chimera-crypto-wasm.js')()
